...
void Game::Init()
{
	...
	skyboxFaces.push_back("Assets/Textures/Skybox/planetrt.jpg");
	skyboxFaces.push_back("Assets/Textures/Skybox/planetlf.jpg");
	skyboxFaces.push_back("Assets/Textures/Skybox/planetup.jpg");
	skyboxFaces.push_back("Assets/Textures/Skybox/planetdn.jpg");
	skyboxFaces.push_back("Assets/Textures/Skybox/planetbk.jpg");
	skyboxFaces.push_back("Assets/Textures/Skybox/planetft.jpg");
